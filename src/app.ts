...
app.register(routes.registerFoodRoutes, { prefix: "alimentos" });
...
app.register(routes.entradaAlimentosRoutes, {
  prefix: "entrada_alimentos",
});

app.register(routes.saidaAlimentosRoutes, {
  prefix: "saida_alimentos",
});
